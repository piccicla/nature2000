//Tag Version: MNP 1.6/09-06-06
var gTagVer = "MNP 1.6/09-06-06";
var gService = true;
var gTimeZone = -8;
function dcsCookie(){
...
function dcsET(){
	...
	//dcsBind("click","dcsRightClick");
	//dcsBind("click","dcsContentRatings");
}
...
//	dcsMultiTrack("WT.dl","3","DCSext.wt_print","1","WT.ad","","WT.mc_id","","WT.sp","","WT.sv_sp","");
//}
	...
	if (evt){
		...
		if (btn!=1){
			...
			if (e.hostname&&e.href&&e.protocol&&(e.protocol.indexOf("http")!=-1)){
				var path=e.pathname?((e.pathname.indexOf("/")!=0)?"/"+e.pathname:e.pathname):"/";				
				if(document.all){var title=e.innerText||e.innerHTML||"";}else{var title=e.text||e.innerHTML||"";}
				dcsMultiTrack("DCS.dcssip",e.hostname,"DCS.dcsuri",path,"DCS.dcsqry",e.search||"","WT.ti","Link:"+title,"WT.dl","1","WT.rc","1","WT.ad","","WT.mc_id","","WT.sp","");
				DCS.dcssip=DCS.dcsuri=DCS.dcsqry=WT.ti=WT.dl=title=WT.rc="";
			}
		}
		}
	}
